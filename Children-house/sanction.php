...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="class=h3 mb-0 text-gray-800">
                                 <a href="pageDsp.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        ...
        <h1 class="h3 mb-0 text-gray-800"> Saisir une nouvelle sanction</h1>
    </div>
                              
    

    <div class="d-sm-flex align-items-center justify-content-between mb-4 form-container ml-2">
    <form action="Add_sanc.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="date" class="form-control form-control-user" name="date_sanction" placeholder="Date sanction" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="type_sanction" placeholder="Type sanction" required>
                            </div>
                            <div class="form-group">
                            <textarea type="text" class="form-control form-control-user" name="description_sn" placeholder="Description" rows="4" cols="50" required></textarea>
                            </div>
