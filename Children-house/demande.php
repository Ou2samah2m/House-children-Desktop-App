...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Secrétaire</a>
                        <a class="collapse-item" href="#">Guide social</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="class=h3 mb-0 text-gray-800">
                                 <a href="doc/Dossier_medical.pdf" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Dossier medical</a>
                                 <a href="doc/Enquete_sociale.pdf" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Enquete social</a>
                                </div>   
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4 form-container">
            <h1 class="h3 mb-0 text-gray-800">Entrez vos informations correctement</h1>
        </div>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4 form-container">
            <form action="confDemande.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="Père orphelin">Père orphelin</option>
                                    <option value="Mère orphelin">Mère orphelin</option>
                                    <option value="Les deux parents orphelin">Les deux parents orphelin</option>
