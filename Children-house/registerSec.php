...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = "INSERT INTO secretaire(name, email, password) VALUES('$name','$email','$pass')";
...
<head>
    ...
    <title>Acceuil Secrétaire</title>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                            <select name="user_type" class="form-control form-control-user">
                                                <option value="cAcceuil" required placeholder>Secrétaire</option>
                                            </select>
                                    </div>
                                </div>
