...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <h1 class="h3 mb-0 text-gray-800"> Saisir une nouvelle absence</h1>
    </div>
                              
    

    <div class="d-sm-flex align-items-center justify-content-between mb-4 form-container ml-2">
    <form action="Add_abs.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="date" class="form-control form-control-user" name="date_abs" placeholder="Date absence" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="duree_abs" placeholder="Durée d'absence(h)" required>
                            </div>
                            <div class="form-group">
                            <textarea type="text" class="form-control form-control-user" name="motif_abs" placeholder="Motif d'absence" rows="4" cols="50" required></textarea>
                            </div>
                            <div class="form-group">
                            <select class="form-control form-control-user" name="status_abs" placeholder="Status d'absence" required>
                                    <option value="Excusée">Excusée</option>
                                    <option value="Non excusée">Non excusée</option>
                                </select>
                            </div>
